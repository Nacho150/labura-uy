...
const gigCatalog = [
  ...
  gig("Pintura por dia", "Jardin y mantenimiento", ["pintura", "pintor", "pared", "rodillo", "lijar"], "Por dia o por tarea", "Herramientas, prolijidad y ejemplos de trabajos si tenes.", "Casas, comercios, reformas, edificios y conocidos.", "media"),
  ...
  gig("Acreditacion o control de ingreso", "Eventos y temporada", ["acreditacion", "control", "ingreso", "evento", "publico"], "Por evento", "Buena presencia, orden y trato con personas.", "Eventos, ferias, fiestas, congresos y productoras.", "facil"),
  ...
  gig("Publicacion de productos en Marketplace", "Digital simple", ["marketplace", "publicaciones", "productos", "fotos", "redes", "ventas"], "Por tarea", "Celular o computadora, buena redaccion y orden.", "Comercios, emprendimientos, vendedores y redes.", "facil"),
  gig("Atencion por WhatsApp", "Digital simple", ["whatsapp", "mensajes", "clientes", "respuesta", "ventas", "atencion"], "Por hora o por mes", "Responder claro, buena ortografia y constancia.", "Comercios, emprendimientos, inmobiliarias y tiendas.", "facil"),
  ...
  gig("Carga de datos basica", "Digital simple", ["datos", "computadora", "excel", "planillas"], "Por tarea o por hora", "Computadora, orden y atencion al detalle.", "Oficinas, comercios, profesionales y emprendimientos.", "facil"),
  gig("Organizacion de agenda", "Digital simple", ["agenda", "turnos", "whatsapp", "telefono"], "Por hora o por mes", "Orden, comunicacion y responsabilidad.", "Consultorios, servicios, profesionales, esteticas y comercios.", "facil"),
...
function selectGigs(scored, context) {
  ...
  for (const item of [...pool, ...fallback]) {
    ...
    const categoryLimit = item.category === "Digital simple" ? 4 : item.category === "Reparto y mandados" ? 3 : item.category === "Jardin y mantenimiento" ? 4 : 2;
